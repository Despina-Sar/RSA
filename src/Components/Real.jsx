      ...
      <Card border="light" className="customcardReal">
        ...
        <Form className="customform mb-3">
              ...
              <Form.Control
                ...
                rows={4}
                value={publicKey || ""}
                placeholder="Public Key will be autogenerated"
                readOnly
                style={{
            ...
            <Form className="customform mb-3">
              ...
              <Form.Control
                ...
                rows={4}
                value={privateKey || ""}
                placeholder="Private Key will be autogenerated"
                readOnly
                style={{
                  background: '#f8f9fa', // Light gray background for better contrast
                  borderRadius: '10px',
          ...
          <Form className="customform mb-3">
            ...
            <Form.Control
                ...
                placeholder="Encrypted message will be autogenerated"
                readOnly
                style={{
                  background: '#f8f9fa', // Light gray background for better contrast
                  borderRadius: '10px',
          ...
          <Form className="customform mb-3">
            <Form.Label>Decrypted Message:</Form.Label>
            <Form.Control
                as="textarea"
                rows={1}
                value={decryptedMessage || ""}
                placeholder="Decrypted message will be autogenerated"
                readOnly
                style={{
                  background: '#f8f9fa', // Light gray background for better contrast
                  borderRadius: '10px',
